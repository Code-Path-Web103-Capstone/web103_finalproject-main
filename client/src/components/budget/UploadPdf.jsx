            ...
            if (response.ok) {
              ...
              try {
                ...
                if (response.ok) {
                  ...
                  try {
                    const deleteResponse = await fetch('http://localhost:3000/api/parser/deletedatafolder', {
                      method: 'DELETE',
                    });
    ...
    <div>
      ...
      <div {...getRootProps()} style={{border: '2px dashed #cccccc', padding: '20px', textAlign: 'center'}}>
        ...
        {isDragActive ? (
            ...
            <p>{file ? `Selected file: ${file.name}` : "Drag 'n' drop a PDF file here, or click to select a file"}</p>
        )}
      </div>
      <div>
