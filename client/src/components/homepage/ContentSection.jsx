...
const ContentSection = () => {
  return (
    <div className="container my-5 flex border-2 border-pink-600">
      <ContentText />
      <ContentImage />
    </div>
  );
...
const ContentText = () => {
  return (
    <div className="flex w-1/2 items-center justify-center border-2 border-green-600">
      <section className="items-left m-8 flex flex-col justify-between space-y-12 border-2">
...
const ContentImage = () => {
  return (
    <div className="flex w-1/2 items-center justify-center border-2 border-blue-600">
